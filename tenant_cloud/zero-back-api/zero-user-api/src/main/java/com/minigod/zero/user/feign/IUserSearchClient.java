...
public interface IUserSearchClient {
	...
	String LIST_BY_USER = AppConstant.FEIGN_API_PREFIX  + "/user/list-by-user";
	String LIST_BY_DEPT = AppConstant.FEIGN_API_PREFIX  + "/user/list-by-dept";
	String LIST_BY_POST = AppConstant.FEIGN_API_PREFIX  + "/user/list-by-post";
	String LIST_BY_ROLE = AppConstant.FEIGN_API_PREFIX  + "/user/list-by-role";
