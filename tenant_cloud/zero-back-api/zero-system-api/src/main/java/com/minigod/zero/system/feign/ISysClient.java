...
public interface ISysClient {
	...
	String MENU = AppConstant.FEIGN_API_PREFIX + "/menu";
	String DEPT = AppConstant.FEIGN_API_PREFIX + "/dept";
	String DEPT_IDS = AppConstant.FEIGN_API_PREFIX + "/dept-ids";
	String DEPT_IDS_FUZZY = AppConstant.FEIGN_API_PREFIX + "/dept-ids-fuzzy";
	String DEPT_NAME = AppConstant.FEIGN_API_PREFIX + "/dept-name";
	String DEPT_NAMES = AppConstant.FEIGN_API_PREFIX + "/dept-names";
	String DEPT_CHILD = AppConstant.FEIGN_API_PREFIX + "/dept-child";
	String POST = AppConstant.FEIGN_API_PREFIX + "/post";
	String POST_IDS = AppConstant.FEIGN_API_PREFIX + "/post-ids";
	String POST_IDS_FUZZY = AppConstant.FEIGN_API_PREFIX + "/post-ids-fuzzy";
	String POST_NAME = AppConstant.FEIGN_API_PREFIX + "/post-name";
	String POST_NAMES = AppConstant.FEIGN_API_PREFIX + "/post-names";
	String ROLE = AppConstant.FEIGN_API_PREFIX + "/role";
	String ROLE_IDS = AppConstant.FEIGN_API_PREFIX + "/role-ids";
	String ROLE_NAME = AppConstant.FEIGN_API_PREFIX + "/role-name";
	String ROLE_NAMES = AppConstant.FEIGN_API_PREFIX + "/role-names";
	String ROLE_ALIAS = AppConstant.FEIGN_API_PREFIX + "/role-alias";
	String ROLE_ALIASES = AppConstant.FEIGN_API_PREFIX + "/role-aliases";
	String TENANT = AppConstant.FEIGN_API_PREFIX + "/tenant";
	String TENANT_ID = AppConstant.FEIGN_API_PREFIX + "/tenant-id";
	String TENANT_DOMAIN = AppConstant.FEIGN_API_PREFIX + "/tenant-domain";
	String TENANT_PACKAGE = AppConstant.FEIGN_API_PREFIX + "/tenant-package";
	String FUNC_CONFIG = AppConstant.FEIGN_API_PREFIX + "/func-config";
	String PARAM = AppConstant.FEIGN_API_PREFIX + "/param";
	String PARAM_VALUE = AppConstant.FEIGN_API_PREFIX + "/param-value";
	String REGION = AppConstant.FEIGN_API_PREFIX + "/region";
	 ...
	 * @return Tenant
	 */
	@GetMapping(TENANT_DOMAIN)
	R<Tenant> getTenant(@RequestParam("tenantId") String tenantId, @RequestParam("domain") String domain);
	 ...
	 *
	 * @param tenantId 租户id
	 * @return FuncConfigEntity
	 */
	@GetMapping(FUNC_CONFIG)
	R<List<FuncConfigVO>> getFuncConfig(@RequestParam("tenantId") String tenantId);
