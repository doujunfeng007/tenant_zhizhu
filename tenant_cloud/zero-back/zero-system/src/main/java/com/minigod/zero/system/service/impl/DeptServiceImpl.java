...
import com.minigod.zero.system.feign.BrokerClient;
import com.minigod.zero.system.mapper.DeptMapper;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements IDeptService {
	...
	public boolean submit(Dept dept) {
		...
		saveOrUpdate(dept);
		// 新增渠道
		R<Boolean> booleanR = brokerClient.saveBrokerChannelByDept(String.valueOf(dept.getId()), dept.getDeptName());
		log.info("请求新增渠道接口返回参数：：{}",booleanR);
