...
public class AuthClientController extends ZeroController {
	...
	*/
	...
	public R<IPage<AuthClient>> pageList(AuthClient authClient, Query query) {
	...
	*/
	...
	@ApiOperationSupport(order = 2)
	@ApiOperation(value = "分页", notes = "传入client")
	public R<List<AuthClient>> list(AuthClientReq req) {
		return R.data(clientService.getClientList(req));
	}
}
