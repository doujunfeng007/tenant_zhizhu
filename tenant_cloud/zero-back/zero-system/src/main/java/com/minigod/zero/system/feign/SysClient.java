...
public class SysClient implements ISysClient {
	...
	public R<Tenant> getTenant(String tenantId, String domain) {
		return R.data(tenantService.getByTenantDomain(tenantId, domain));
	}
	...
	public R<List<FuncConfigVO>> getFuncConfig(String tenantId) {
		List<FuncConfigVO> funcConfigs = funcConfigService.getByTenantId(tenantId);
		return R.data(funcConfigs);
	}
