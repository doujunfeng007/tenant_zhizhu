...
package com.minigod.zero.flow.business.controller;
...
public class WorkController {
	...
	public R<IPage<ZeroFlow>> claimList(@ApiParam("流程信息") ZeroFlow zeroFlow, Query query) {
		IPage<ZeroFlow> pages = flowBusinessService.selectClaimPage(Condition.getPage(query), zeroFlow);
		return R.data(pages);
	}
	...
	public R<IPage<ZeroFlow>> todoList(@ApiParam("流程信息") ZeroFlow zeroFlow, Query query) {
		IPage<ZeroFlow> pages = flowBusinessService.selectTodoPage(Condition.getPage(query), zeroFlow);
		return R.data(pages);
	}
	...
	public R<IPage<ZeroFlow>> sendList(@ApiParam("流程信息") ZeroFlow zeroFlow, Query query) {
		IPage<ZeroFlow> pages = flowBusinessService.selectSendPage(Condition.getPage(query), zeroFlow);
		return R.data(pages);
	}
	...
	public R<IPage<ZeroFlow>> doneList(@ApiParam("流程信息") ZeroFlow zeroFlow, Query query) {
		IPage<ZeroFlow> pages = flowBusinessService.selectDonePage(Condition.getPage(query), zeroFlow);
		return R.data(pages);
	}
	...
	public R completeTask(@ApiParam("任务信息") @RequestBody ZeroFlow flow) {
