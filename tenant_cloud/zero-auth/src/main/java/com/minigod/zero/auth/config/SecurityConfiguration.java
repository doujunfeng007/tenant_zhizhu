...
import com.minigod.zero.auth.support.ZeroPasswordEncoderFactories;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter { // 过时类待优化
	...
	protected void configure(HttpSecurity http) {
		http.authorizeRequests().antMatchers("/back/oauth/checkPwd","/back/oauth/verification_code").permitAll();
	...
	public void configure(WebSecurity web) {
		web.ignoring().antMatchers("/js/*.js", "/css/*.css","/appConfig/dynamic-url/**");
	}
