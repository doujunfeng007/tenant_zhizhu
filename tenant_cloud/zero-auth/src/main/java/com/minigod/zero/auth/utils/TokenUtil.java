...
public class TokenUtil {
	...
	public final static String USER_HAS_TOO_MANY_FAILS = "账号已冻结,请重置密码后再试";
	...
	public final static String QUOT_TOKEN = "quotToken";
	public final static String QUOT_AUTH = "quotAuth";
	public final static String UPDATE_PWD = "updatePwd";

	private static ZeroTenantProperties tenantProperties;
	 ...
	 */
	private static ZeroTenantProperties getTenantProperties() {
		if (tenantProperties == null) {
			tenantProperties = SpringUtil.getBean(ZeroTenantProperties.class);
		}
		return tenantProperties;
	}
	...
	public static boolean judgeTenant(Tenant tenant) {
		...
		if (StringUtil.equalsIgnoreCase(tenant.getTenantId(), ZeroConstant.ADMIN_TENANT_ID)) {
			return false;
		}
