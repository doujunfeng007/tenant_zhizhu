...
如果没有远程访问,会报 `Connect to 192.168.1.250:2375 [/192.168.1.250] failed: Connection refused: connect`
...
{
  "registry-mirrors": ["https://3dse7md.mirror.aliyuncs.com"],
  "insecure-registries":["192.168.1.250"]
}
```
...
RUN mkdir -p /zero-cloud/gateway

WORKDIR /zero-cloud/gateway

EXPOSE 80

ADD ./target/zero-gateway.jar ./app.jar
