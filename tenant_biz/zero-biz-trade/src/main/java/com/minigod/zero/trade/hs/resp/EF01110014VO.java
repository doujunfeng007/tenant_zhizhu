 ...
 * 查资金帐号列表
 */
public class EF01110014VO implements Serializable {
    ...
    public String getOrganAuditDate() {
        return organAuditDate;
    }

    public void setOrganAuditDate(String organAuditDate) {
