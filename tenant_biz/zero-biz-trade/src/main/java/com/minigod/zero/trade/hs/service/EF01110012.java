...
import com.minigod.zero.trade.hs.req.EF01110012Request;
import com.minigod.zero.trade.hs.resp.EF01110012VO;
 ...
 */
@Component
@GrmFunctionEntity(requestVo = EF01110012Request.class,responseVo = EF01110012VO.class)
public class EF01110012<T extends GrmRequestVO>  extends T2sdkBiz<T> {
    @Override
    protected Map<String, String> parseParamsFromRequestObject(GrmRequestVO request, Map<String, String> oParamMap) {
        if(request instanceof EF01110012Request) {
            EF01110012Request req = (EF01110012Request) request;
        ...
        if(grmDataVO.getErrorId().equals(GrmConstants.GRM_RESPONSE_OK)){
           List<Map<String,String>> list =  grmDataVO.getResult();
            ...
            while(iterator.hasNext()){
                ...
                vo.setSumBuyAmount(rowMap.get(HsConstants.Fields.SUM_BUY_AMOUNT));
