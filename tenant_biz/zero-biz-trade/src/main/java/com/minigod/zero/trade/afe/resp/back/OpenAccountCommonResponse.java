 ...
 */
@Data
public class OpenAccountCommonResponse implements Serializable {
	...
	public boolean isSuccess() {
		return result != null && result.returncode != null && result.returncode.success != null;
	}
	...
	public String getMessage() {
		String message ="系统异常";
		Map<String, Object> dynamicProperties =result.getReturncode().getDynamicProperties();
