...
import com.minigod.zero.trade.hs.resp.EF01100840VO;
 ...
 */
@Component
@GrmFunctionEntity(requestVo = EF01100840Request.class, responseVo = EF01100840VO.class)
public class EF01100840<T extends GrmRequestVO> extends T2sdkBiz<T> {

    @Override
    protected Map<String, String> parseParamsFromRequestObject(GrmRequestVO request, Map<String, String> oParamMap) {
        if (request instanceof EF01100840Request) {
    ...
    protected <R extends GrmRequestVO> GrmResponseVO parseResponse(GrmDataVO grmDataVO, Map<String, String> oParam, R request) {
        ...
        if (grmDataVO.getErrorId().equals(GrmConstants.GRM_RESPONSE_OK)) {
            ...
            List<EF01100840VO> listVo = new ArrayList<>();
            String assetId;
            while (iterator.hasNext()) {
                ...
                EF01100840VO vo = new EF01100840VO();
