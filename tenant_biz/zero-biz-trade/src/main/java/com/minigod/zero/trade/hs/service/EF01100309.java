...
import com.minigod.zero.trade.hs.req.EF01100309Request;
import com.minigod.zero.trade.hs.resp.EF01100309VO;
 ...
 */
@Component
@GrmFunctionEntity(requestVo = EF01100309Request.class,responseVo = EF01100309VO.class)
public class EF01100309<T extends GrmRequestVO>  extends T2sdkBiz<T> {

    @Override
    protected Map<String, String> parseParamsFromRequestObject(GrmRequestVO request, Map<String, String> oParamMap) {
        if(request instanceof EF01100309Request){
            EF01100309Request req = (EF01100309Request) request;
            ...
            reqMap.put(HsConstants.Fields.COST_PRICE,req.getCostPrice());
