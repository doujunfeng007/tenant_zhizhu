...
@Data
public class OpenAccountAppointmentProtocol implements Serializable {

	private Long openUserInfoId;
...
//    private String industryRange;
	...
	//财富来源
	@JSONField(name = "wealthSource")
	private List<Integer> wealthSource;
	...
	@JSONField(name = "fundInvestmentExperienceType")
	...
	//您是否确认个人资料（私隐）条例通知并同意yff证券及其控股集团使用及向其他人士提供本人的个人资料作直接促销用途[0=否 1=是]
	...
	private List<OpenAccountImageInfoProtocol> openAccountImagesInfo;
	...
	// 是否拥有10%或以上的股权：1-是；0：否
	@JSONField(name = "industryStock")
	private String industryStock;

	// 手机号码来源：1-大陆地址 2-香港地址 3-其他地区
	@JSONField(name = "phoneType")
	private String phoneType;

	// 现时地址类型 [1-大陆地址 2-香港地址 3-其他地区];
	@JSONField(name = "familyAddressType")
	private String familyAddressType;

	// 公司地址类型 [1-大陆地址 2-香港地址 3-其他地区];
	@JSONField(name = "companyAddressType")
	...
	@JSONField(name = "yfFundStatus")
	private Integer yfFundStatus;

	//证件签发地
	@JSONField(name = "issueCountry")
	private String issueCountry;

	//其他证件签发地
	@JSONField(name = "otherIssueCountry")
	...
	//其他出生地
	@JSONField(name = "otherBirthPlace")
	private String otherBirthPlace;

	//从业年限
	@JSONField(name = "employYears")
