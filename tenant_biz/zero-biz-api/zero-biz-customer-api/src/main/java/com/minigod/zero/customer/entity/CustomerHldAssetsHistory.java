...
/**
 * 用户活利得资产历史记录
 * @TableName customer_hld_assets_history
 */
@Data
public class CustomerHldAssetsHistory implements Serializable {
    /**
     *
     */
    private Integer id;
	...
	public CustomerHldAssetsHistory(Long custId,String accountId,String date){
		this.custId = custId;
