...
/**
 * 债券易子账户信息表
 * @TableName customer_bond_capital_account
 */
public class CustomerBondCapitalAccount implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        CustomerBondCapitalAccount other = (CustomerBondCapitalAccount) that;
