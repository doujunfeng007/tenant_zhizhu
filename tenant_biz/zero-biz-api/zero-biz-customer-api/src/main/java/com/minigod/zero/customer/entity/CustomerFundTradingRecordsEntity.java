...
@ApiModel(value = "CustomerFundTransactionRecords对象", description = "客户交易流水汇总表")
@EqualsAndHashCode(callSuper = true)
public class CustomerFundTradingRecordsEntity extends BaseEntity {


	/**
	 * 客户ID
	 */
	@ApiModelProperty(value="subAccountId客户ID")
	 ...
	 * 基金代码
	 */
	@ApiModelProperty(value="fundCode基金代码")
	private String fundCode;

	/**
	 * 基金名称
	 */
	@ApiModelProperty(value="fundName基金名称")
