...
/**
 * 用户基金资产历史记录
 * @TableName customer_fund_assets_history
 */
@Data
public class CustomerFundAssetsHistory implements Serializable {
    /**
     *
     */
    private Integer id;
	...
	public CustomerFundAssetsHistory(Long custId,String accountId,String date){
		this.custId = custId;
