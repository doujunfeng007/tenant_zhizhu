...
@Data
@TableName("sys_item_config")
@ApiModel(value = "SysItemConfig系统通用文本配置", description = "系统通用文本配置表")
public class SysItemConfigEntity implements Serializable {
	...
	public boolean equals(Object that) {
		...
		SysItemConfigEntity other = (SysItemConfigEntity) that;
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
			&& (this.getTenantId() == null ? other.getTenantId() == null : this.getTenantId().equals(other.getTenantId()))
			&& (this.getItemType() == null ? other.getItemType() == null : this.getItemType().equals(other.getItemType()))
			&& (this.getItemLabel() == null ? other.getItemLabel() == null : this.getItemLabel().equals(other.getItemLabel()))
	...
	public int hashCode() {
		...
		result = prime * result + ((getItemLabel() == null) ? 0 : getItemLabel().hashCode());
