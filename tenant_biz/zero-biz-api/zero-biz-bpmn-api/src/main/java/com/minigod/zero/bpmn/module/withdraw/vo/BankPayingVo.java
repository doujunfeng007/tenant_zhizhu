...
/**
 * 公司付款银行信息视图对象 bank_paying
 *
 * @author chenyu
 * @date 2023-04-06
 */
@Data
@ApiModel("公司付款银行信息视图对象")
@ExcelIgnoreUnannotated
public class BankPayingVo  {
     ...
     * 付款银行英文名称
     */
    @ExcelProperty(value = "付款银行英文名称")
    @ApiModelProperty("付款银行英文名称")
     ...
     * 服务类别[SEC-证券 FET-期货]
     */
    @ExcelProperty(value = "服务类别[SEC-证券 FET-期货]")
    @ApiModelProperty("服务类别[SEC-证券 FET-期货]")
     ...
     * 柜台退款公司银行代码
     */
    @ExcelProperty(value = "柜台退款公司银行代码")
    @ApiModelProperty("柜台退款公司银行代码")
    private String gtInBankCode;

    /**
     * 柜台退款付款银行账户
     */
    @ExcelProperty(value = "柜台退款付款银行账户")
    @ApiModelProperty("柜台退款付款银行账户")
    private String gtInBankAcct;

    /**
     * 柜台退款手续费公司银行代码
     */
    @ExcelProperty(value = "柜台退款手续费公司银行代码")
     ...
     * 柜台退款手续费付款银行账户
     */
    @ExcelProperty(value = "柜台退款手续费付款银行账户")
     ...
     * 柜台取款公司银行代码
     */
    @ExcelProperty(value = "柜台取款公司银行代码")
    @ApiModelProperty("柜台取款公司银行代码")
    private String gtOutBankCode;

    /**
     * 柜台取款付款银行账户
     */
    @ExcelProperty(value = "柜台取款付款银行账户")
    @ApiModelProperty("柜台取款付款银行账户")
