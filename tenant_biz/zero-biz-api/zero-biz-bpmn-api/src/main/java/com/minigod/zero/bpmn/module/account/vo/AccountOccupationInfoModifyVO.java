 ...
 */
@Data
@ApiModel(value = "AccountOccupationInfoModifyVO", description = "客户职业信息修改返回对象")
public class AccountOccupationInfoModifyVO implements Serializable {
	 ...
	 * 就业情况类型
	 */
	@ApiModelProperty(value = "就业情况类型")
	private String professionCodeName;

	/**
	 * 就业情况类型其它
	 */
	@ApiModelProperty(value = "就业情况类型其它")
