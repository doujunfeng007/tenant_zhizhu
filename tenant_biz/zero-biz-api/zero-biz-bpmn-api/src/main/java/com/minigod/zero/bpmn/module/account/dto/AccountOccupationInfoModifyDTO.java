 ...
 */
@Data
@ApiModel(value = "AccountOccupationInfoModifyDTO", description = "客户职业信息")
public class AccountOccupationInfoModifyDTO implements Serializable {
	 ...
	 * 公司电话城市编码
	 */
	@ApiModelProperty(value = "公司电话城市编码")
