...
@ApiModel("账户余额请求实体")
@Data
public class AccountBalanceRequestVO extends DbsBaseRequestVO implements Serializable {
    ...
    // 银行账号
    @ApiModelProperty(value = "账户币种[HKD:港币 CNY:人民币 USD:美元 MCA:多币种]", required = true)
