...
package com.minigod.zero.biz.common.launch;

import com.minigod.zero.biz.common.constant.LauncherConstant;
import com.minigod.zero.constant.NacosConstant;
...
public class LauncherServiceImpl implements LauncherService {
	...
	public void launcher(SpringApplicationBuilder builder, String appName, String profile, boolean isLocalDev) {
		...
		if(appName.equals(AppConstant.SERVICE_BIZ_TASK_NAME)){
		...
		PropsUtil.setProperty(props, "spring.cloud.nacos.config.shared-configs[0].group", com.minigod.zero.constant.NacosConstant.NACOS_CONFIG_GROUP);
		PropsUtil.setProperty(props, "spring.cloud.nacos.config.shared-configs[0].refresh", com.minigod.zero.constant.NacosConstant.NACOS_CONFIG_REFRESH);
		PropsUtil.setProperty(props, "spring.cloud.nacos.config.shared-configs[1].data-id", LauncherConstant.sharedDataId(profile));
		PropsUtil.setProperty(props, "spring.cloud.nacos.config.shared-configs[1].group", com.minigod.zero.constant.NacosConstant.NACOS_CONFIG_GROUP);
