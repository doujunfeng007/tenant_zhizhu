...
public class OpenApiConstant {
	...
	@Value("${saas.cash.bank.url:}")
	private String SAAS_CASH_BANK_URL;
    ...
    // 银行卡proxy接口
//    public static String CASH_QUERY_RECEIVING_ACCOUNT_NEW;
//    public static String CASH_QUERY_DEPOSIT_BANK_BY_ID;
//    public static String CASH_QUERY_DEPOSIT_BANK_LIST;
//    public static String CASH_QUERY_RECEIVING_ACCOUNT;
//    public static String CASH_QUERY_DEPOSIT_BANK_BY_DEPOSIT_BANK_BY_ID;
//    public static String CASH_QUERY_DEPOSIT_WAYS;
//    public static String CASH_QUERY_RECEIVING_ACCOUNT_BY_DEPOSIT_BANK_ID;
//    public static String CASH_QUERY_BANK_SWIFT_CODE;
//    public static String CASH_QUERY_WITHDRAW_BANK_LIST;
...
//		CASH_QUERY_RECEIVING_ACCOUNT_NEW = SAAS_CASH_BANK_URL + "/proxy/cash/receiving_account_new";
//		CASH_QUERY_DEPOSIT_BANK_BY_ID = SAAS_CASH_BANK_URL + "/proxy/cash/deposit_bank_detail";
//		CASH_QUERY_DEPOSIT_BANK_LIST = SAAS_CASH_BANK_URL + "/proxy/cash/deposit_bank_list";
//		CASH_QUERY_RECEIVING_ACCOUNT = SAAS_CASH_BANK_URL + "/proxy/cash/receiving_account";
//		CASH_QUERY_DEPOSIT_BANK_BY_DEPOSIT_BANK_BY_ID = SAAS_CASH_BANK_URL + "/proxy/cash/deposit_bank_list/depositBankById";
//		CASH_QUERY_RECEIVING_ACCOUNT_BY_DEPOSIT_BANK_ID = SAAS_CASH_BANK_URL + "/proxy/cash/receiving_account/depositBankById";
//		CASH_QUERY_BANK_SWIFT_CODE = SAAS_CASH_BANK_URL + "/proxy/cash/bank_swift_code";
//		CASH_QUERY_WITHDRAW_BANK_LIST = SAAS_CASH_BANK_URL + "/proxy/cash/withdraw_bank_list";
//		CASH_QUERY_DEPOSIT_WAYS = SAAS_CASH_BANK_URL + "/proxy/cash/deposit_ways";
    }
