 ...
 */
@Data
@TableName("customer_fund_asset_records")
@ApiModel(value = "CustomerFundAssetRecords对象", description = "客户资产流水汇总表")
@EqualsAndHashCode(callSuper = true)
public class CustomerFundAssetRecordsEntity extends BaseEntity {
	/**
	 * 租户id
	 */
