...
public class TokenUtil {
	...
	public final static String EXPIRES_IN = TokenConstant.EXPIRES_IN;
	...
	public final static String CUSTOMER_SERVER_ERROR = "用户服务请求失败";
	public final static String IS_WHITE_LIST = "isWhiteList";
