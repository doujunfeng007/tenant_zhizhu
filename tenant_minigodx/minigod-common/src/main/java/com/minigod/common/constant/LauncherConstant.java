...
public interface LauncherConstant {
	 ...
	 * xxljob
	 */
	String APPLICATION_XXLJOB_NAME = AppConstant.APPLICATION_NAME_PREFIX + "xxljob";

	/**
	 * xxljob
	 */
	String APPLICATION_XXLJOB_ADMIN_NAME = AppConstant.APPLICATION_NAME_PREFIX + "xxljob-admin";
