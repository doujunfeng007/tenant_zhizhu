...
-- 新增模型设计菜单
-- -----------------------------------
INSERT INTO `minigod_menu`(`id`, `parent_id`, `code`, `name`, `alias`, `path`, `source`, `sort`, `category`, `action`, `is_open`, `component`, `remark`, `is_deleted`) VALUES (1161272593873321996, 1123598815738675217, 'model', '数据模型设计', 'menu', '/tool/model', 'iconfont icon-biaodan', 3, 1, 0, 1, '', '', 0);

-- -----------------------------------
-- 新增 数据模型表
-- -----------------------------------
CREATE TABLE `minigod_model`  (
...
-- 新增 数据原型表
-- -----------------------------------
CREATE TABLE `minigod_model_prototype`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
