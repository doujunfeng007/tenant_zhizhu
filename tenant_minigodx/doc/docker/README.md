...
MAINTAINER minigod@minigod.com

RUN mkdir -p /minigod-mkt/gateway

WORKDIR /minigod-mkt/gateway

EXPOSE 80

ADD ./target/minigod-gateway.jar ./app.jar
...
```
minigod-gateway:
  image: "${REGISTER}/minigod-gateway:${TAG}"
  ports:
  - 80:80
  networks:
    minigod_net:
